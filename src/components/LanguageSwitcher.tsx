        ...
        <div className="absolute left-full top-0 ml-1 w-40 bg-white rounded-md shadow-lg py-1 z-20">
          <button
            ...
            className={`flex items-center gap-2 w-full text-left px-4 py-2 text-sm ${
              language === 'en' ? 'bg-green-50 text-green-700 font-medium' : 'text-gray-700 hover:bg-gray-100'
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 w-full text-left px-4 py-2 text-sm ${
              language === 'fr' ? 'bg-green-50 text-green-700 font-medium' : 'text-gray-700 hover:bg-gray-100'
            }`}
          >
            <span className="text-lg">🇫🇷</span>
            Français
